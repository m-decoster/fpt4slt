...
class TextVocabulary(Vocabulary):
    def __init__(self, tokens: List[str] = None, file: str = None, mBartVocab: bool = False):
        """
...
def build_vocab(
    field: str, max_size: int, min_freq: int, dataset: Dataset, vocab_file: str = None, mBartVocab: bool = False,
) -> Vocabulary:
    """
